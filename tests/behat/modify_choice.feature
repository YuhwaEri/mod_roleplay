@mod @mod_roleplay
Feature: Teacher can modify roleplays of the students
  In order to have all students roleplays
  As a teacher
  I need to be able to make roleplay for studnets
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | roleplay   | Roleplay name | Test roleplay description | C1     | roleplay1  | Option 1, Option 2, Option 3 |

  @javascript
  Scenario: Delete students roleplay response as a teacher
  ...
  @javascript
  Scenario: Teacher can delete answers in the multiple answer roleplay
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Roleplay name"
    And I navigate to "Edit settings" in current page administration
    And I set the field "Allow more than one roleplay to be selected" to "Yes"
    And I press "Save and return to course"
    And I log out
    And I log in as "student1"
    And I am on "Course 1" course homepage
