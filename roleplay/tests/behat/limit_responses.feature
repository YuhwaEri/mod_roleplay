@mod @mod_roleplay
Feature: Limit roleplay responses
  In order to restrict students from selecting a response more than a specified number of times
  As a teacher
  I need to limit the roleplay responses

  Scenario: Limit the number of responses allowed for a roleplay activity and verify the result as students
