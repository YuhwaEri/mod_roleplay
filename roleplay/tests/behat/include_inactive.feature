...
Feature: Include responses from inactive users
  In order to view responses from inactive or suspended users in roleplay results
  As a teacher
  I need to enable the roleplay include inactive option
  ...
  Scenario: Enable the roleplay include inactive option and check that responses from inactive students are visible
  ...
  Scenario: Disable the roleplay include inactive option and check that responses from inactive students are not visible
    Given I add a "Roleplay" to section "1" and I fill the form with:
      | Roleplay name | Roleplay name |
      | Description | Roleplay Description |
      | option[0] | Option 1 |
