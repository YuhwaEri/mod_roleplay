 ...
 *      - int roleplayd: The id of the roleplay
 * }
 *
 * @package    mod_roleplay
 * @since      Moodle 3.1
...
class report_downloaded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportdownloaded', 'mod_roleplay');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has downloaded the report in the '".$this->other['format']."' format for
            the roleplay activity with course module id '$this->contextinstanceid'";
    }
